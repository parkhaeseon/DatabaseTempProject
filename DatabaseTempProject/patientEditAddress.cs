...
{
    public partial class patientEditAddress : Form
    {
        public patientEdit pE_ad;

        public patientEditAddress(patientEdit _pE_ad)
        {
            InitializeComponent();
        ...
        private void roadaddr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    pE_ad.newAddress.Text = getA;
                    pE_ad.newAddress.ReadOnly = true;
                    this.Close();
                }
                else
                {
