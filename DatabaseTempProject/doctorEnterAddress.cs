...
{
    public partial class doctorEnterAddress : Form
    {
        public doctorEnter dE;

        public doctorEnterAddress(doctorEnter _dE)
        {
            InitializeComponent();
        ...
        private void roadaddr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    dE.doctorAddress.Text = getA;
                    dE.doctorAddress.ReadOnly = true;
                    this.Close();
                }
                else
                {
