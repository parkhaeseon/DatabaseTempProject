...
{
    public partial class docaddredit : Form
    {
        public docEditForm addr;

        public docaddredit(docEditForm _addr)
        {
            InitializeComponent();
        ...
        private void roadaddr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    addr.newAddress.Text = getA;
                    addr.newAddress.ReadOnly = true;
                    this.Close();
                }
                else
                {
