...
{
    public partial class addSearchEnter : Form
    {
        public employeeEnter empe;
        
        public addSearchEnter(employeeEnter _emp)
        {
            InitializeComponent();
            this.empe = _emp;
        }
        ...
        private void roadaddr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    empe.Address.Text = getA;
                    empe.Address.ReadOnly = true;
                    this.Close();
                }
                else
                {
